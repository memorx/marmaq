  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const payload: CreateOrdenInput = {
        ...
        anticipo: anticipo ? parseFloat(anticipo) : undefined,
              ...
              <div className="mt-4 pt-4 border-t border-gray-100">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-8 pr-4 py-2.5 rounded-lg border border-gray-300 bg-white text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#31A7D4] focus:border-transparent"
                    placeholder="0.00"
                  />
                </div>
              </div>
